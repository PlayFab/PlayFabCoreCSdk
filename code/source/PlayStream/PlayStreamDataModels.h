...
class ExportPlayersInSegmentResult : public Wrappers::PFPlayStreamExportPlayersInSegmentResultWrapper<Allocator>, public OutputModel<PFPlayStreamExportPlayersInSegmentResult>
{
public:
...
class GetPlayersInSegmentExportResponse : public Wrappers::PFPlayStreamGetPlayersInSegmentExportResponseWrapper<Allocator>, public OutputModel<PFPlayStreamGetPlayersInSegmentExportResponse>
{
public:
