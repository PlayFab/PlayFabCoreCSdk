...
public:
    ...
    // ------------ Generated API calls
    static AsyncOp<ExportPlayersInSegmentResult> AdminExportPlayersInSegment(SharedPtr<GlobalState const> state, const ExportPlayersInSegmentRequest& request, const TaskQueue& queue);
    ...
    static AsyncOp<GetPlayersInSegmentExportResponse> AdminGetSegmentExport(SharedPtr<GlobalState const> state, const GetPlayersInSegmentExportRequest& request, const TaskQueue& queue);
