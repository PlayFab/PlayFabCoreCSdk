...
public:
    ...
    static AsyncOp<void> AdminDeleteMembershipSubscription(SharedPtr<GlobalState const> state, const DeleteMembershipSubscriptionRequest& request, const TaskQueue& queue);
    ...
    static AsyncOp<void> AdminSetMembershipOverride(SharedPtr<GlobalState const> state, const SetMembershipOverrideRequest& request, const TaskQueue& queue);
    ...
    static AsyncOp<GetPlayFabIDsFromGooglePlayGamesPlayerIDsResult> ClientGetPlayFabIDsFromGooglePlayGamesPlayerIDs(SharedPtr<TitlePlayer> entity, const GetPlayFabIDsFromGooglePlayGamesPlayerIDsRequest& request, const TaskQueue& queue);
    ...
    static AsyncOp<GetPlayFabIDsFromNintendoServiceAccountIdsResult> ClientGetPlayFabIDsFromNintendoServiceAccountIds(SharedPtr<TitlePlayer> entity, const GetPlayFabIDsFromNintendoServiceAccountIdsRequest& request, const TaskQueue& queue);
    ...
    static AsyncOp<void> ClientLinkGooglePlayGamesServicesAccount(SharedPtr<TitlePlayer> entity, const LinkGooglePlayGamesServicesAccountRequest& request, const TaskQueue& queue);
    ...
    static AsyncOp<void> ClientLinkNintendoServiceAccount(SharedPtr<TitlePlayer> entity, const ClientLinkNintendoServiceAccountRequest& request, const TaskQueue& queue);
    static AsyncOp<void> ClientLinkNintendoSwitchDeviceId(SharedPtr<TitlePlayer> entity, const ClientLinkNintendoSwitchDeviceIdRequest& request, const TaskQueue& queue);
    ...
    static AsyncOp<void> ClientUnlinkGooglePlayGamesServicesAccount(SharedPtr<TitlePlayer> entity, const UnlinkGooglePlayGamesServicesAccountRequest& request, const TaskQueue& queue);
    ...
    static AsyncOp<void> ClientUnlinkNintendoServiceAccount(SharedPtr<TitlePlayer> entity, const ClientUnlinkNintendoServiceAccountRequest& request, const TaskQueue& queue);
    static AsyncOp<void> ClientUnlinkNintendoSwitchDeviceId(SharedPtr<TitlePlayer> entity, const ClientUnlinkNintendoSwitchDeviceIdRequest& request, const TaskQueue& queue);
    ...
    static AsyncOp<GetPlayFabIDsFromNintendoServiceAccountIdsResult> ServerGetPlayFabIDsFromNintendoServiceAccountIds(SharedPtr<GlobalState const> state, const GetPlayFabIDsFromNintendoServiceAccountIdsRequest& request, const TaskQueue& queue);
    ...
    static AsyncOp<GetPlayFabIDsFromTwitchIDsResult> ServerGetPlayFabIDsFromTwitchIDs(SharedPtr<GlobalState const> state, const GetPlayFabIDsFromTwitchIDsRequest& request, const TaskQueue& queue);
    ...
    static AsyncOp<void> ServerLinkNintendoServiceAccount(SharedPtr<GlobalState const> state, const ServerLinkNintendoServiceAccountRequest& request, const TaskQueue& queue);
    static AsyncOp<void> ServerLinkNintendoSwitchDeviceId(SharedPtr<GlobalState const> state, const ServerLinkNintendoSwitchDeviceIdRequest& request, const TaskQueue& queue);
    ...
    static AsyncOp<void> ServerUnlinkNintendoServiceAccount(SharedPtr<GlobalState const> state, const ServerUnlinkNintendoServiceAccountRequest& request, const TaskQueue& queue);
    static AsyncOp<void> ServerUnlinkNintendoSwitchDeviceId(SharedPtr<GlobalState const> state, const ServerUnlinkNintendoSwitchDeviceIdRequest& request, const TaskQueue& queue);
