...
AsyncOp<void> AccountManagementAPI::AdminDeleteMembershipSubscription(
    SharedPtr<GlobalState const> state,
    const DeleteMembershipSubscriptionRequest& request,
    const TaskQueue& queue
)
{
    auto secretKey{ state->SecretKey() };
    ...
    const char* path{ "/Admin/DeleteMembershipSubscription" };
    JsonValue requestBody{ request.ToJson() };
    UnorderedMap<String, String> headers{{ kSecretKeyHeaderName, *secretKey }};
...
AsyncOp<void> AccountManagementAPI::AdminSetMembershipOverride(
    SharedPtr<GlobalState const> state,
    const SetMembershipOverrideRequest& request,
    const TaskQueue& queue
)
{
    auto secretKey{ state->SecretKey() };
    ...
    const char* path{ "/Admin/SetMembershipOverride" };
    JsonValue requestBody{ request.ToJson() };
    UnorderedMap<String, String> headers{{ kSecretKeyHeaderName, *secretKey }};
