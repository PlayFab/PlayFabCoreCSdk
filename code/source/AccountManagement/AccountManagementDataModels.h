...
class DeleteMembershipSubscriptionRequest : public Wrappers::PFAccountManagementDeleteMembershipSubscriptionRequestWrapper<Allocator>, public InputModel
{
public:
    using ModelWrapperType = typename Wrappers::PFAccountManagementDeleteMembershipSubscriptionRequestWrapper<Allocator>;
    using ModelWrapperType::ModelType;
    ...
    // InputModel
    JsonValue ToJson() const override;
    static JsonValue ToJson(const PFAccountManagementDeleteMembershipSubscriptionRequest& input);
...
class SetMembershipOverrideRequest : public Wrappers::PFAccountManagementSetMembershipOverrideRequestWrapper<Allocator>, public InputModel
{
public:
    using ModelWrapperType = typename Wrappers::PFAccountManagementSetMembershipOverrideRequestWrapper<Allocator>;
    using ModelWrapperType::ModelType;
    ...
    // InputModel
    JsonValue ToJson() const override;
    static JsonValue ToJson(const PFAccountManagementSetMembershipOverrideRequest& input);
