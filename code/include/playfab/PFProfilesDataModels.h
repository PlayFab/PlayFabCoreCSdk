...
/// <summary>
/// PFProfilesGetGlobalPolicyRequest data model. Retrieves the title access policy that is used before
/// the profile's policy is inspected during a request. If never customized this will return the default
/// starter policy built by PlayFab.
/// </summary>
typedef struct PFProfilesGetGlobalPolicyRequest
{
    /// <summary>
...
/// <summary>
/// PFProfilesGetGlobalPolicyResponse data model.
/// </summary>
typedef struct PFProfilesGetGlobalPolicyResponse
{
    /// <summary>
...
} PFProfilesGetGlobalPolicyResponse;
...
typedef struct PFProfilesEntityStatisticChildValue
{
    ...
    /// </summary>
    _Maybenull_ _Null_terminated_ const char* childName;
...
typedef struct PFProfilesEntityStatisticValue
{
    ...
    /// </summary>
    _Maybenull_ _Field_size_(childStatisticsCount) struct PFProfilesEntityStatisticChildValueDictionaryEntry const* childStatistics;
...
typedef struct PFProfilesEntityProfileBody
{
    ...
    /// </summary>
    _Maybenull_ _Null_terminated_ const char* leaderboardMetadata;
...
/// <summary>
/// PFProfilesSetGlobalPolicyRequest data model. Updates the title access policy that is used before
...
/// </summary>
typedef struct PFProfilesSetGlobalPolicyRequest
{
    /// <summary>
    /// (Optional) The optional custom tags associated with the request (e.g. build number, external
    /// trace identifiers, etc.).
...
} PFProfilesSetGlobalPolicyRequest;
...
typedef struct PFProfilesSetEntityProfilePolicyRequest
{
    ...
    /// </summary>
    _Maybenull_ _Field_size_(statementsCount) PFProfilesEntityPermissionStatement const* const* statements;
