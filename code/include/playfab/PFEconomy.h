...
/// <remarks>
/// If successful, call <see cref="PFEconomyAdminRefundPurchaseGetResult"/> to get the result.
/// </remarks>
...
/// <summary>
/// Gets the result of a successful PFEconomyAdminRefundPurchaseAsync call.
/// </summary>
/// <param name="async">XAsyncBlock for the async operation.</param>
...
/// <returns>Result code for this API operation.</returns>
/// <remarks>
/// If successful, call <see cref="PFEconomyAdminResolvePurchaseDisputeGetResult"/> to get the result.
/// </remarks>
...
/// <summary>
/// Gets the result of a successful PFEconomyAdminResolvePurchaseDisputeAsync call.
/// </summary>
/// <param name="async">XAsyncBlock for the async operation.</param>
/// <param name="bufferSize">The size of the buffer for the result object.</param>
/// <param name="buffer">Byte buffer used for the result value and its fields.</param>
