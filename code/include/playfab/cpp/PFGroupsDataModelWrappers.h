...
{
public:
    using ModelType = typename PFGroupsAcceptGroupApplicationRequest;
...
{
public:
    using ModelType = typename PFGroupsAcceptGroupInvitationRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsAddMembersRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsApplyToGroupRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
    ...
    PFGroupsApplyToGroupRequestWrapper(const PFGroupsApplyToGroupRequest& model) :
        ...
        m_autoAcceptOutstandingInvite{ model.autoAcceptOutstandingInvite ? StdExtra::optional<bool>{ *model.autoAcceptOutstandingInvite } : StdExtra::nullopt },
        m_customTags{ model.customTags, model.customTags + model.customTagsCount },
        m_entity{ model.entity ? StdExtra::optional<PFEntityKeyWrapper<Alloc>>{ *model.entity } : StdExtra::nullopt },
        m_group{ model.group ? *model.group : decltype(*model.group){} }
    {
    ...
    void SetAutoAcceptOutstandingInvite(StdExtra::optional<bool> value)
    {
...
{
public:
    using ModelType = typename PFGroupsEntityWithLineage;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
    ...
    PFGroupsEntityWithLineageWrapper(const PFGroupsEntityWithLineage& model) :
        ...
        m_key{ model.key ? StdExtra::optional<PFEntityKeyWrapper<Alloc>>{ *model.key } : StdExtra::nullopt },
    ...
    void SetKey(StdExtra::optional<PFEntityKeyWrapper<Alloc>> value)
    {
...
private:
    ...
    StdExtra::optional<PFEntityKeyWrapper<Alloc>> m_key;
...
{
public:
    using ModelType = typename PFGroupsApplyToGroupResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
    ...
    PFGroupsApplyToGroupResponseWrapper(const PFGroupsApplyToGroupResponse& model) :
        ...
        m_entity{ model.entity ? StdExtra::optional<PFGroupsEntityWithLineageWrapper<Alloc>>{ *model.entity } : StdExtra::nullopt },
        m_group{ model.group ? StdExtra::optional<PFEntityKeyWrapper<Alloc>>{ *model.group } : StdExtra::nullopt }
    {
        SetModelPointers();
    }
    ...
    void SetEntity(StdExtra::optional<PFGroupsEntityWithLineageWrapper<Alloc>> value)
    {
        m_entity = std::move(value);
        this->m_model.entity = m_entity ? &m_entity->Model() : nullptr;
    }
    ...
    void SetGroup(StdExtra::optional<PFEntityKeyWrapper<Alloc>> value)
    {
        m_group = std::move(value);
...
private:
    ...
    StdExtra::optional<PFGroupsEntityWithLineageWrapper<Alloc>> m_entity;
    StdExtra::optional<PFEntityKeyWrapper<Alloc>> m_group;
};
...
{
public:
    using ModelType = typename PFGroupsBlockEntityRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsChangeMemberRoleRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsCreateGroupRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsCreateGroupResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsCreateGroupRoleRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsCreateGroupRoleResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsDeleteGroupRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsDeleteRoleRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsGetGroupRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsGetGroupResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsInviteToGroupRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
    ...
    PFGroupsInviteToGroupRequestWrapper(const PFGroupsInviteToGroupRequest& model) :
        ...
        m_autoAcceptOutstandingApplication{ model.autoAcceptOutstandingApplication ? StdExtra::optional<bool>{ *model.autoAcceptOutstandingApplication } : StdExtra::nullopt },
        m_customTags{ model.customTags, model.customTags + model.customTagsCount },
        m_entity{ model.entity ? *model.entity : decltype(*model.entity){} },
        m_group{ model.group ? *model.group : decltype(*model.group){} },
        m_roleId{ SafeString(model.roleId) }
    ...
    void SetAutoAcceptOutstandingApplication(StdExtra::optional<bool> value)
    {
...
{
public:
    using ModelType = typename PFGroupsInviteToGroupResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
    ...
    PFGroupsInviteToGroupResponseWrapper(const PFGroupsInviteToGroupResponse& model) :
        ...
        m_group{ model.group ? StdExtra::optional<PFEntityKeyWrapper<Alloc>>{ *model.group } : StdExtra::nullopt },
        m_invitedByEntity{ model.invitedByEntity ? StdExtra::optional<PFGroupsEntityWithLineageWrapper<Alloc>>{ *model.invitedByEntity } : StdExtra::nullopt },
        m_invitedEntity{ model.invitedEntity ? StdExtra::optional<PFGroupsEntityWithLineageWrapper<Alloc>>{ *model.invitedEntity } : StdExtra::nullopt },
        m_roleId{ SafeString(model.roleId) }
    {
        SetModelPointers();
    }
    ...
    void SetInvitedByEntity(StdExtra::optional<PFGroupsEntityWithLineageWrapper<Alloc>> value)
    {
        m_invitedByEntity = std::move(value);
        this->m_model.invitedByEntity = m_invitedByEntity ? &m_invitedByEntity->Model() : nullptr;
    }

    void SetInvitedEntity(StdExtra::optional<PFGroupsEntityWithLineageWrapper<Alloc>> value)
    {
...
private:
    ...
    StdExtra::optional<PFEntityKeyWrapper<Alloc>> m_group;
    StdExtra::optional<PFGroupsEntityWithLineageWrapper<Alloc>> m_invitedByEntity;
    StdExtra::optional<PFGroupsEntityWithLineageWrapper<Alloc>> m_invitedEntity;
    String m_roleId;
};
...
{
public:
    using ModelType = typename PFGroupsIsMemberRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsIsMemberResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsListGroupApplicationsRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsGroupApplication;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsListGroupApplicationsResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsListGroupBlocksRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsGroupBlock;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsListGroupBlocksResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsListGroupInvitationsRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsGroupInvitation;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsListGroupInvitationsResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsListGroupMembersRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsEntityMemberRole;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsListGroupMembersResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsListMembershipRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsGroupRole;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsGroupWithRoles;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsListMembershipResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsListMembershipOpportunitiesRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsListMembershipOpportunitiesResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsRemoveGroupApplicationRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsRemoveGroupInvitationRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsRemoveMembersRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsUnblockEntityRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsUpdateGroupRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
    ...
    PFGroupsUpdateGroupRequestWrapper(const PFGroupsUpdateGroupRequest& model) :
        ...
        m_adminRoleId{ SafeString(model.adminRoleId) },
        m_customTags{ model.customTags, model.customTags + model.customTagsCount },
        m_expectedProfileVersion{ model.expectedProfileVersion ? StdExtra::optional<int32_t>{ *model.expectedProfileVersion } : StdExtra::nullopt },
        m_group{ model.group ? *model.group : decltype(*model.group){} },
        m_groupName{ SafeString(model.groupName) },
        m_memberRoleId{ SafeString(model.memberRoleId) }
    {
    ...
    void SetExpectedProfileVersion(StdExtra::optional<int32_t> value)
    {
...
{
public:
    using ModelType = typename PFGroupsUpdateGroupResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
    ...
    PFGroupsUpdateGroupResponseWrapper(const PFGroupsUpdateGroupResponse& model) :
        ...
        m_setResult{ model.setResult ? StdExtra::optional<PFOperationTypes>{ *model.setResult } : StdExtra::nullopt }
    {
        SetModelPointers();
    }
    ...
    void SetSetResult(StdExtra::optional<PFOperationTypes> value)
    {
...
{
public:
    using ModelType = typename PFGroupsUpdateGroupRoleRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFGroupsUpdateGroupRoleResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
