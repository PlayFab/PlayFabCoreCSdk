...
{
public:
    using ModelType = typename PFDataAbortFileUploadsRequest;
    ...
    PFDataAbortFileUploadsRequestWrapper(const PFDataAbortFileUploadsRequest& model) :
        ...
        m_profileVersion{ model.profileVersion ? StdExtra::optional<int32_t>{ *model.profileVersion } : StdExtra::nullopt }
    {
        SetModelPointers();
    }
    ...
    void SetProfileVersion(StdExtra::optional<int32_t> value)
    {
...
{
public:
    using ModelType = typename PFDataAbortFileUploadsResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataDeleteFilesRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataDeleteFilesResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataFinalizeFileUploadsRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataGetFileMetadata;
    using DictionaryEntryType = typename PFDataGetFileMetadataDictionaryEntry;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataFinalizeFileUploadsResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataGetFilesRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataGetFilesResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataGetObjectsRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
    ...
    PFDataGetObjectsRequestWrapper(const PFDataGetObjectsRequest& model) :
        ...
        m_customTags{ model.customTags, model.customTags + model.customTagsCount },
        m_entity{ model.entity ? *model.entity : decltype(*model.entity){} },
        m_escapeObject{ model.escapeObject ? StdExtra::optional<bool>{ *model.escapeObject } : StdExtra::nullopt }
    {
        SetModelPointers();
    }
    ...
    void SetEscapeObject(StdExtra::optional<bool> value)
    {
...
{
public:
    using ModelType = typename PFDataObjectResult;
    using DictionaryEntryType = typename PFDataObjectResultDictionaryEntry;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataGetObjectsResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataInitiateFileUploadsRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataInitiateFileUploadMetadata;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataInitiateFileUploadsResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataSetObject;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
    ...
    PFDataSetObjectWrapper(const PFDataSetObject& model) :
        ...
        m_dataObject{ model.dataObject },
        m_deleteObject{ model.deleteObject ? StdExtra::optional<bool>{ *model.deleteObject } : StdExtra::nullopt },
        m_escapedDataObject{ SafeString(model.escapedDataObject) },
        m_objectName{ SafeString(model.objectName) }
    {
        SetModelPointers();
    ...
    void SetDeleteObject(StdExtra::optional<bool> value)
    {
...
{
public:
    using ModelType = typename PFDataSetObjectsRequest;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataSetObjectInfo;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
...
{
public:
    using ModelType = typename PFDataSetObjectsResponse;
    using String = typename std::basic_string<char, std::char_traits<char>, Alloc<char>>;
    template<typename T> using Vector = typename std::vector<T, Alloc<T>>;
