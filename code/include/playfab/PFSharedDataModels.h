...
typedef struct PFExecuteCloudScriptResult
{
    ...
    /// </summary>
    _Maybenull_ PFScriptExecutionError const* error;
    ...
    /// failures.
    /// </summary>
    _Maybenull_ _Field_size_(logsCount) PFLogStatement const* const* logs;
...
typedef struct PFResultTableNode
{
    ...
    /// </summary>
    _Null_terminated_ const char* resultItem;
...
typedef struct PFGetRandomResultTablesResult
{
    ...
    /// </summary>
    _Maybenull_ _Field_size_(tablesCount) struct PFRandomResultTableListingDictionaryEntry const* tables;
