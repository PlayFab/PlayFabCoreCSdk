...
protected:
    ...
    void FillAdminCreatePlayerStatisticDefinitionRequest(PlayFab::Wrappers::PFLeaderboardCreatePlayerStatisticDefinitionRequestWrapper<>& request);
    ...
    void FillAdminGetPlayerStatisticVersionsRequest(PlayFab::Wrappers::PFLeaderboardGetPlayerStatisticVersionsRequestWrapper<>& request);
    static HRESULT ValidateAdminGetPlayerStatisticVersionsResponse(PFLeaderboardGetPlayerStatisticVersionsResult* result);

    void FillAdminIncrementPlayerStatisticVersionRequest(PlayFab::Wrappers::PFLeaderboardIncrementPlayerStatisticVersionRequestWrapper<>& request);
    ...
    void FillAdminResetUserStatisticsRequest(PlayFab::Wrappers::PFLeaderboardResetUserStatisticsRequestWrapper<>& request);

    void FillAdminUpdatePlayerStatisticDefinitionRequest(PlayFab::Wrappers::PFLeaderboardUpdatePlayerStatisticDefinitionRequestWrapper<>& request);
    ...
    void FillClientGetFriendLeaderboardRequest(PlayFab::Wrappers::PFLeaderboardClientGetFriendLeaderboardRequestWrapper<>& request);
    static HRESULT ValidateClientGetFriendLeaderboardResponse(PFLeaderboardGetLeaderboardResult* result);

    void FillClientGetFriendLeaderboardAroundPlayerRequest(PlayFab::Wrappers::PFLeaderboardGetFriendLeaderboardAroundPlayerRequestWrapper<>& request);
    ...
    void FillClientGetLeaderboardRequest(PlayFab::Wrappers::PFLeaderboardGetLeaderboardRequestWrapper<>& request);
    static HRESULT ValidateClientGetLeaderboardResponse(PFLeaderboardGetLeaderboardResult* result);

    void FillClientGetLeaderboardAroundPlayerRequest(PlayFab::Wrappers::PFLeaderboardGetLeaderboardAroundPlayerRequestWrapper<>& request);
    static HRESULT ValidateClientGetLeaderboardAroundPlayerResponse(PFLeaderboardGetLeaderboardAroundPlayerResult* result);

    void FillClientGetPlayerStatisticsRequest(PlayFab::Wrappers::PFLeaderboardClientGetPlayerStatisticsRequestWrapper<>& request);
    static HRESULT ValidateClientGetPlayerStatisticsResponse(PFLeaderboardClientGetPlayerStatisticsResult* result);

    void FillClientGetPlayerStatisticVersionsRequest(PlayFab::Wrappers::PFLeaderboardGetPlayerStatisticVersionsRequestWrapper<>& request);
    static HRESULT ValidateClientGetPlayerStatisticVersionsResponse(PFLeaderboardGetPlayerStatisticVersionsResult* result);

    void FillClientUpdatePlayerStatisticsRequest(PlayFab::Wrappers::PFLeaderboardClientUpdatePlayerStatisticsRequestWrapper<>& request);

    void FillServerGetFriendLeaderboardRequest(PlayFab::Wrappers::PFLeaderboardServerGetFriendLeaderboardRequestWrapper<>& request);
    static HRESULT ValidateServerGetFriendLeaderboardResponse(PFLeaderboardGetLeaderboardResult* result);

    void FillServerGetLeaderboardRequest(PlayFab::Wrappers::PFLeaderboardGetLeaderboardRequestWrapper<>& request);
    static HRESULT ValidateServerGetLeaderboardResponse(PFLeaderboardGetLeaderboardResult* result);

    void FillServerGetLeaderboardAroundUserRequest(PlayFab::Wrappers::PFLeaderboardGetLeaderboardAroundUserRequestWrapper<>& request);
    static HRESULT ValidateServerGetLeaderboardAroundUserResponse(PFLeaderboardGetLeaderboardAroundUserResult* result);

    void FillServerGetPlayerStatisticsRequest(PlayFab::Wrappers::PFLeaderboardServerGetPlayerStatisticsRequestWrapper<>& request);
    static HRESULT ValidateServerGetPlayerStatisticsResponse(PFLeaderboardServerGetPlayerStatisticsResult* result);

    void FillServerGetPlayerStatisticVersionsRequest(PlayFab::Wrappers::PFLeaderboardGetPlayerStatisticVersionsRequestWrapper<>& request);
    static HRESULT ValidateServerGetPlayerStatisticVersionsResponse(PFLeaderboardGetPlayerStatisticVersionsResult* result);

    void FillServerUpdatePlayerStatisticsRequest(PlayFab::Wrappers::PFLeaderboardServerUpdatePlayerStatisticsRequestWrapper<>& request);
