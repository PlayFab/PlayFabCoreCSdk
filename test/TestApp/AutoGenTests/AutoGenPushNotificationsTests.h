...
protected:
    ...
    void FillServerDeletePushNotificationTemplateRequest(PlayFab::Wrappers::PFPushNotificationsDeletePushNotificationTemplateRequestWrapper<>& request);

    void FillServerSavePushNotificationTemplateRequest(PlayFab::Wrappers::PFPushNotificationsSavePushNotificationTemplateRequestWrapper<>& request);
    ...
    void FillServerSendPushNotificationRequest(PlayFab::Wrappers::PFPushNotificationsSendPushNotificationRequestWrapper<>& request);

    void FillServerSendPushNotificationFromTemplateRequest(PlayFab::Wrappers::PFPushNotificationsSendPushNotificationFromTemplateRequestWrapper<>& request);
