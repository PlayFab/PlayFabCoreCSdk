...
protected:
    ...
    void FillAdminGetDataReportRequest(PlayFab::Wrappers::PFPlayerDataManagementGetDataReportRequestWrapper<>& request);
    static HRESULT ValidateAdminGetDataReportResponse(PFPlayerDataManagementGetDataReportResult* result);

    void FillAdminGetUserDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateAdminGetUserDataResponse(PFPlayerDataManagementAdminGetUserDataResult* result);

    void FillAdminGetUserInternalDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateAdminGetUserInternalDataResponse(PFPlayerDataManagementAdminGetUserDataResult* result);

    void FillAdminGetUserPublisherDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateAdminGetUserPublisherDataResponse(PFPlayerDataManagementAdminGetUserDataResult* result);

    void FillAdminGetUserPublisherInternalDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateAdminGetUserPublisherInternalDataResponse(PFPlayerDataManagementAdminGetUserDataResult* result);

    void FillAdminGetUserPublisherReadOnlyDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateAdminGetUserPublisherReadOnlyDataResponse(PFPlayerDataManagementAdminGetUserDataResult* result);

    void FillAdminGetUserReadOnlyDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateAdminGetUserReadOnlyDataResponse(PFPlayerDataManagementAdminGetUserDataResult* result);

    void FillAdminUpdateUserDataRequest(PlayFab::Wrappers::PFPlayerDataManagementAdminUpdateUserDataRequestWrapper<>& request);
    static HRESULT ValidateAdminUpdateUserDataResponse(PFPlayerDataManagementUpdateUserDataResult* result);

    void FillAdminUpdateUserInternalDataRequest(PlayFab::Wrappers::PFPlayerDataManagementUpdateUserInternalDataRequestWrapper<>& request);
    static HRESULT ValidateAdminUpdateUserInternalDataResponse(PFPlayerDataManagementUpdateUserDataResult* result);

    void FillAdminUpdateUserPublisherDataRequest(PlayFab::Wrappers::PFPlayerDataManagementAdminUpdateUserDataRequestWrapper<>& request);
    static HRESULT ValidateAdminUpdateUserPublisherDataResponse(PFPlayerDataManagementUpdateUserDataResult* result);

    void FillAdminUpdateUserPublisherInternalDataRequest(PlayFab::Wrappers::PFPlayerDataManagementUpdateUserInternalDataRequestWrapper<>& request);
    static HRESULT ValidateAdminUpdateUserPublisherInternalDataResponse(PFPlayerDataManagementUpdateUserDataResult* result);

    void FillAdminUpdateUserPublisherReadOnlyDataRequest(PlayFab::Wrappers::PFPlayerDataManagementAdminUpdateUserDataRequestWrapper<>& request);
    static HRESULT ValidateAdminUpdateUserPublisherReadOnlyDataResponse(PFPlayerDataManagementUpdateUserDataResult* result);

    void FillAdminUpdateUserReadOnlyDataRequest(PlayFab::Wrappers::PFPlayerDataManagementAdminUpdateUserDataRequestWrapper<>& request);
    static HRESULT ValidateAdminUpdateUserReadOnlyDataResponse(PFPlayerDataManagementUpdateUserDataResult* result);

    void FillClientGetUserDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateClientGetUserDataResponse(PFPlayerDataManagementClientGetUserDataResult* result);

    void FillClientGetUserPublisherDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateClientGetUserPublisherDataResponse(PFPlayerDataManagementClientGetUserDataResult* result);

    void FillClientGetUserPublisherReadOnlyDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateClientGetUserPublisherReadOnlyDataResponse(PFPlayerDataManagementClientGetUserDataResult* result);

    void FillClientGetUserReadOnlyDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateClientGetUserReadOnlyDataResponse(PFPlayerDataManagementClientGetUserDataResult* result);

    void FillClientUpdateUserDataRequest(PlayFab::Wrappers::PFPlayerDataManagementClientUpdateUserDataRequestWrapper<>& request);
    static HRESULT ValidateClientUpdateUserDataResponse(PFPlayerDataManagementUpdateUserDataResult* result);

    void FillClientUpdateUserPublisherDataRequest(PlayFab::Wrappers::PFPlayerDataManagementClientUpdateUserDataRequestWrapper<>& request);
    static HRESULT ValidateClientUpdateUserPublisherDataResponse(PFPlayerDataManagementUpdateUserDataResult* result);

    void FillServerGetUserDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateServerGetUserDataResponse(PFPlayerDataManagementServerGetUserDataResult* result);

    void FillServerGetUserInternalDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateServerGetUserInternalDataResponse(PFPlayerDataManagementServerGetUserDataResult* result);

    void FillServerGetUserPublisherDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateServerGetUserPublisherDataResponse(PFPlayerDataManagementServerGetUserDataResult* result);

    void FillServerGetUserPublisherInternalDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateServerGetUserPublisherInternalDataResponse(PFPlayerDataManagementServerGetUserDataResult* result);

    void FillServerGetUserPublisherReadOnlyDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateServerGetUserPublisherReadOnlyDataResponse(PFPlayerDataManagementServerGetUserDataResult* result);

    void FillServerGetUserReadOnlyDataRequest(PlayFab::Wrappers::PFPlayerDataManagementGetUserDataRequestWrapper<>& request);
    static HRESULT ValidateServerGetUserReadOnlyDataResponse(PFPlayerDataManagementServerGetUserDataResult* result);

    void FillServerUpdateUserDataRequest(PlayFab::Wrappers::PFPlayerDataManagementServerUpdateUserDataRequestWrapper<>& request);
    static HRESULT ValidateServerUpdateUserDataResponse(PFPlayerDataManagementUpdateUserDataResult* result);

    void FillServerUpdateUserInternalDataRequest(PlayFab::Wrappers::PFPlayerDataManagementUpdateUserInternalDataRequestWrapper<>& request);
    static HRESULT ValidateServerUpdateUserInternalDataResponse(PFPlayerDataManagementUpdateUserDataResult* result);

    void FillServerUpdateUserPublisherDataRequest(PlayFab::Wrappers::PFPlayerDataManagementServerUpdateUserDataRequestWrapper<>& request);
    static HRESULT ValidateServerUpdateUserPublisherDataResponse(PFPlayerDataManagementUpdateUserDataResult* result);

    void FillServerUpdateUserPublisherInternalDataRequest(PlayFab::Wrappers::PFPlayerDataManagementUpdateUserInternalDataRequestWrapper<>& request);
    static HRESULT ValidateServerUpdateUserPublisherInternalDataResponse(PFPlayerDataManagementUpdateUserDataResult* result);

    void FillServerUpdateUserPublisherReadOnlyDataRequest(PlayFab::Wrappers::PFPlayerDataManagementServerUpdateUserDataRequestWrapper<>& request);
    static HRESULT ValidateServerUpdateUserPublisherReadOnlyDataResponse(PFPlayerDataManagementUpdateUserDataResult* result);

    void FillServerUpdateUserReadOnlyDataRequest(PlayFab::Wrappers::PFPlayerDataManagementServerUpdateUserDataRequestWrapper<>& request);
