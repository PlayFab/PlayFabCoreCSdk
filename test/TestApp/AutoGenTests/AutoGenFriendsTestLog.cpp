...
HRESULT AutoGenFriendsTests::LogAddFriendResult(PFFriendsAddFriendResult const* result)
{
    if (!TestApp::ShouldTrace(PFTestTraceLevel::Information))
    {
        return S_OK;
...
HRESULT AutoGenFriendsTests::LogGetFriendsListResult(PFFriendsGetFriendsListResult const* result)
{
    if (!TestApp::ShouldTrace(PFTestTraceLevel::Information))
    {
        return S_OK;
