...
protected:
    ...
    static void FillClientAcceptTradeRequest(PlayFab::Wrappers::PFTradingAcceptTradeRequestWrapper<>& request);
    static HRESULT ValidateClientAcceptTradeResponse(PFTradingAcceptTradeResponse* result);

    static void FillClientCancelTradeRequest(PlayFab::Wrappers::PFTradingCancelTradeRequestWrapper<>& request);
    static HRESULT ValidateClientCancelTradeResponse(PFTradingCancelTradeResponse* result);

    static void FillClientGetPlayerTradesRequest(PlayFab::Wrappers::PFTradingGetPlayerTradesRequestWrapper<>& request);
    static HRESULT ValidateClientGetPlayerTradesResponse(PFTradingGetPlayerTradesResponse* result);

    static void FillClientGetTradeStatusRequest(PlayFab::Wrappers::PFTradingGetTradeStatusRequestWrapper<>& request);
    static HRESULT ValidateClientGetTradeStatusResponse(PFTradingGetTradeStatusResponse* result);

    static void FillClientOpenTradeRequest(PlayFab::Wrappers::PFTradingOpenTradeRequestWrapper<>& request);
