...
protected:
    ...
    void FillCreateExclusionGroupRequest(PlayFab::Wrappers::PFExperimentationCreateExclusionGroupRequestWrapper<>& request);
    static HRESULT ValidateCreateExclusionGroupResponse(PFExperimentationCreateExclusionGroupResult* result);

    void FillCreateExperimentRequest(PlayFab::Wrappers::PFExperimentationCreateExperimentRequestWrapper<>& request);
    static HRESULT ValidateCreateExperimentResponse(PFExperimentationCreateExperimentResult* result);

    void FillDeleteExclusionGroupRequest(PlayFab::Wrappers::PFExperimentationDeleteExclusionGroupRequestWrapper<>& request);

    void FillDeleteExperimentRequest(PlayFab::Wrappers::PFExperimentationDeleteExperimentRequestWrapper<>& request);

    void FillGetExclusionGroupsRequest(PlayFab::Wrappers::PFExperimentationGetExclusionGroupsRequestWrapper<>& request);
    static HRESULT ValidateGetExclusionGroupsResponse(PFExperimentationGetExclusionGroupsResult* result);

    void FillGetExclusionGroupTrafficRequest(PlayFab::Wrappers::PFExperimentationGetExclusionGroupTrafficRequestWrapper<>& request);
    static HRESULT ValidateGetExclusionGroupTrafficResponse(PFExperimentationGetExclusionGroupTrafficResult* result);

    void FillGetExperimentsRequest(PlayFab::Wrappers::PFExperimentationGetExperimentsRequestWrapper<>& request);
    static HRESULT ValidateGetExperimentsResponse(PFExperimentationGetExperimentsResult* result);

    void FillGetLatestScorecardRequest(PlayFab::Wrappers::PFExperimentationGetLatestScorecardRequestWrapper<>& request);
    static HRESULT ValidateGetLatestScorecardResponse(PFExperimentationGetLatestScorecardResult* result);

    void FillGetTreatmentAssignmentRequest(PlayFab::Wrappers::PFExperimentationGetTreatmentAssignmentRequestWrapper<>& request);
    static HRESULT ValidateGetTreatmentAssignmentResponse(PFExperimentationGetTreatmentAssignmentResult* result);

    void FillStartExperimentRequest(PlayFab::Wrappers::PFExperimentationStartExperimentRequestWrapper<>& request);

    void FillStopExperimentRequest(PlayFab::Wrappers::PFExperimentationStopExperimentRequestWrapper<>& request);

    void FillUpdateExclusionGroupRequest(PlayFab::Wrappers::PFExperimentationUpdateExclusionGroupRequestWrapper<>& request);

    void FillUpdateExperimentRequest(PlayFab::Wrappers::PFExperimentationUpdateExperimentRequestWrapper<>& request);
