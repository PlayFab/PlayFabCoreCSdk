...
protected:
    ...
    void FillAdminDeleteContentRequest(PlayFab::Wrappers::PFContentDeleteContentRequestWrapper<>& request);

    void FillAdminGetContentListRequest(PlayFab::Wrappers::PFContentGetContentListRequestWrapper<>& request);
    static HRESULT ValidateAdminGetContentListResponse(PFContentGetContentListResult* result);

    void FillAdminGetContentUploadUrlRequest(PlayFab::Wrappers::PFContentGetContentUploadUrlRequestWrapper<>& request);
    static HRESULT ValidateAdminGetContentUploadUrlResponse(PFContentGetContentUploadUrlResult* result);

    void FillClientGetContentDownloadUrlRequest(PlayFab::Wrappers::PFContentGetContentDownloadUrlRequestWrapper<>& request);
    static HRESULT ValidateClientGetContentDownloadUrlResponse(PFContentGetContentDownloadUrlResult* result);

    void FillServerGetContentDownloadUrlRequest(PlayFab::Wrappers::PFContentGetContentDownloadUrlRequestWrapper<>& request);
