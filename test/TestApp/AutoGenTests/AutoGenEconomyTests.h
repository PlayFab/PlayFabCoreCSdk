...
protected:
    ...
    static void FillAdminRefundPurchaseRequest(PlayFab::Wrappers::PFEconomyRefundPurchaseRequestWrapper<>& request);
    static HRESULT ValidateAdminRefundPurchaseResponse(PFEconomyRefundPurchaseResponse* result);

    static void FillAdminResolvePurchaseDisputeRequest(PlayFab::Wrappers::PFEconomyResolvePurchaseDisputeRequestWrapper<>& request);
